...
-------------------------------------------------
local TeleportButtons = BS.Addon:NewModule("TeleportButtons")

-------------------------------------------------
-- Module Metadata (for BS.API compatibility)
-------------------------------------------------
TeleportButtons.name = "BS_TB"
TeleportButtons.label = "Teleport Buttons"
TeleportButtons.isQOLModule = true
TeleportButtons.enabled = true
TeleportButtons.defaults = {
    enabled = true,
}
...
-------------------------------------------------
BS.API:Register(TeleportButtons)
...
function TeleportButtons:OnDisable()
    self.db = BS.DB:EnsureDB(self.name, self.defaults)
    self.enabled = false
